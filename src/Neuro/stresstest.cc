...
int main() {
  ...
  first->importDataBase(
      "/Users/gonzo/program/school21/general/CPP7_MLP-0/src/Neuro/resources/"
      "best_weights.bin");
  second->importDataBase(
      "/Users/gonzo/program/school21/general/CPP7_MLP-0/src/Neuro/resources/"
      "best_weights.bin");
  int count = 10;
  ...
  while (count--) {
    first->test(
        "/Users/gonzo/program/school21/general/CPP7_MLP-0/datasets/"
